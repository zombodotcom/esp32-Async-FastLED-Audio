...
#define HOSTNAME "ESP32-Zombo" ///< Hostname. The setup function adds the Chip ID at the end.
IPAddress local_ip(192,168,1,1);
IPAddress gateway(192,168,1,1);
IPAddress subnet(255,255,255,0);

const bool apMode = false;
const bool STA_AP_MODE=true;
const bool station_only=false;

// AP mode password
const char WiFiAPPSK[] = "testinglongpass";
